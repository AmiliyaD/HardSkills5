        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
            <div class="sidebar-sticky">
                ...
                <h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-muted">
                    <span>{{$evSes->name}}</span>
                </h6>
                <ul class="nav flex-column">
                    <li class="nav-item"><a class="nav-link" href="{{ route('detail', ['id'=>$evSes->id]) }}">Просмотр события</a></li>
                </ul>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            <div class="border-bottom mb-3 pt-3 pb-2">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center">
                    <h1 class="h2">{{$evSes->name}}</h1>
                </div>
                <span class="h6">{{$evSes->date}}</span>
            </div>

            <div class="mb-3 pt-3 pb-2">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center">
                    <h2 class="h4">Создать новую сессию</h2>
                </div>
            </div>

            <form class="needs-validation" method="POST" novalidate action="{{ route('saveSession') }}">
                @csrf
                <div class="row">
...
{{-- ПРОВЕРИТЬ НА СВОБОДНЫЕ ДАТЫ В СЕССИИ  --}}
                <div class="row">
                    <div class="col-12 col-lg-4 mb-3">
                        <label for="inputTitle">Заголовок</label>
                        <!-- adding the class is-invalid to the input, shows the invalid feedback below -->
                        <input type="text" class="form-control is-invalid" value="" id="inputTitle" name="title" placeholder="" value="">
                ...
                <input type="hidden" name="event_id" value="{{$evSes->id}}">
                <div class="row">
                    <div class="col-12 col-lg-4 mb-3">
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        <label for="textareaDescription">Описсание</label>
                ...
                <a href="{{ route('detail', $evSes->id) }}" class="btn btn-link">Назад</a>
            </form>
            @if ($errors->any())
